...
@Controller
class TaximeterSocksController(
	val simpMessagingTemplate: SimpMessagingTemplate,
	val taximeterService: TaximeterService
) {
	...
	fun taximeterStart(@Payload taximeterUpdate: TaximeterUpdate, @DestinationVariable("uuid") userUUID: String) {
		...
		simpMessagingTemplate.convertAndSend(
			...
			TaximeterResponseModel(
				TaximeterType.TAXIMETER_START, coordinates = taximeterUpdate.coordinates,
	...
	fun taximeterStop(@Payload taximeterUpdate: TaximeterUpdate, @DestinationVariable("uuid") userUUID: String) {
		...
		simpMessagingTemplate.convertAndSend(
			"/topic/${taximeterUpdate.recipientUUID}/taximeter",
			TaximeterResponseModel(
				TaximeterType.TAXIMETER_STOP, coordinates = taximeterUpdate.coordinates,
	...
	fun taximeterWaiting(
		@Payload taximeterUpdate: TaximeterUpdate, @DestinationVariable("uuid") userUUID: String,
		...
		simpMessagingTemplate.convertAndSend(
			...
			TaximeterResponseModel(
				...
				coordinates = taximeterUpdate.coordinates,
				isWaiting = isWaiting
			)
		)
	}
